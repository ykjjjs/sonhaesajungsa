...
L1 = {
 ...
 "lead": "손해사정은 사고가 보상 대상인지 판단하고, 손해액과 보험금을 확정하는 일이다. 절차가 곧 업무의 뼈대다.",
 "html": """
...
L2 = {
 ...
 "lead": "공제는 소액 손해를 걸러 내고 도덕적 위태를 줄이는 장치다. 방식마다 계산이 달라 계산 문제로 직결된다.",
 "html": """
...
L3 = {
 ...
 "lead": "손해보험의 보험금은 실제 손해를 넘지 않는다. 그런데 실무에는 이 원칙이 그대로 적용되지 않는 자리가 몇 군데 있다.",
 "html": """
...
L4 = {
 ...
 "lead": "언제 일어난 사고를 담보하는가, 아니면 언제 청구된 건을 담보하는가. 이 선택이 배상책임보험의 성격을 결정한다.",
 "html": """
...
<div class="bx c"><h5><span class="bdg">개념</span>청구기준의 두 장치</h5>
  ...
  <p>“보험계약 체결 이후 발생한 사고가 대상이다”라는 설명이 틀린 이유가 여기 있다. 소급담보일자가 계약 체결 전으로 설정되면 그 이후의 사고도 담보된다.</p></div></div>
...
RE1 = {
 ...
 "lead": "재보험은 보험자가 인수한 위험을 다시 넘기는 계약이다. 원보험과의 관계, 그리고 재보험이 하는 네 가지 일이 이 절의 내용이다.",
 "html": """
...
RE2 = {
 ...
 "lead": "재보험의 두 갈래는 나누는 대상이 다르다. 비례는 <b>보험금액</b>을 나누고, 비비례는 <b>손해액</b>을 나눈다. 이 한 줄이 모든 차이를 만든다.",
 "html": """
